...
void DrawRoads()
{
    ...
    Rectangle leftRoadRect = Rectangle{
        .x = 0,
        .y = WINDOW_CENTER.y - ROAD_SIZE / 2,
        .width = WINDOW_CENTER.x - ROAD_SIZE / 2,
        .height = ROAD_SIZE //
    };
    ...
    Rectangle leftRoadOuterUpperLineRect = Rectangle{
        .x = 0,
        .y = WINDOW_CENTER.y - ROAD_SIZE / 2 + ROAD_OUTER_LINE_PADDING,
        .width = WINDOW_CENTER.x - ROAD_SIZE / 2,
        .height = ROAD_OUTER_LINE_WIDTH //
    };
    Rectangle leftRoadOuterLowerLineRect = Rectangle{
        .x = 0,
        .y = WINDOW_CENTER.y + ROAD_SIZE / 2 - ROAD_OUTER_LINE_PADDING - ROAD_OUTER_LINE_WIDTH,
        .width = WINDOW_CENTER.x - ROAD_SIZE / 2,
        .height = ROAD_OUTER_LINE_WIDTH //
    };
    ...
    Rectangle leftRoadMiddleLineRect = Rectangle{
        .x = 0,
        .y = WINDOW_CENTER.y - ROAD_MIDDLE_LINE_WIDTH / 2,
        .width = WINDOW_CENTER.x - ROAD_SIZE / 2,
    ...
    Rectangle topRoadRect = Rectangle{
        ...
        .y = 0,
        .width = ROAD_SIZE,
        .height = WINDOW_CENTER.y - ROAD_SIZE / 2 //
    };

    // outer lines
    Rectangle topRoadOuterLeftLineRect = Rectangle{
        .x = WINDOW_CENTER.x - ROAD_SIZE / 2 + ROAD_OUTER_LINE_PADDING,
        .y = 0,
        .width = ROAD_OUTER_LINE_WIDTH,
        .height = WINDOW_CENTER.y - ROAD_SIZE / 2 //
    };
    Rectangle topRoadOuterRightLineRect = Rectangle{
        .x = WINDOW_CENTER.x + ROAD_SIZE / 2 - ROAD_OUTER_LINE_PADDING - ROAD_OUTER_LINE_WIDTH,
        .y = 0,
        .width = ROAD_OUTER_LINE_WIDTH,
        .height = WINDOW_CENTER.y - ROAD_SIZE / 2 //
    };
    ...
    Rectangle topRoadMiddleLineRect = Rectangle{
        .x = WINDOW_CENTER.x - ROAD_MIDDLE_LINE_WIDTH / 2,
        .y = 0,
