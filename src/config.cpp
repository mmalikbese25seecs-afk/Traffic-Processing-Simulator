...
Node BuildConfigTree()
{
    ...
    tl_adaptive.children.push_back(
        Node{"Refresh Interval", ConfigValue{"tl_adaptive_tick_rate", ValueType::Int, 1, 1, 10}, {}, false});
    tl_adaptive.children.push_back(
    ...
    debug_car.children.push_back(
        Node{"Collision Detection Arc", ConfigValue{"debug_car_detection_arc", ValueType::Bool, false}, {}, false});
    debug_car.children.push_back(
        Node{"Detection Other Cars", ConfigValue{"debug_car_detection_other_cars", ValueType::Bool, false}, {}, false});
    debug_car.children.push_back(
        Node{"State (Waiting/ Moving)", ConfigValue{"debug_car_state", ValueType::Bool, false}, {}, false});
    debug_options.children.push_back(debug_car);

    Node debug_tl;
    debug_tl.title = "Traffic Light";
    debug_tl.children.push_back(
        Node{"Detection Range", ConfigValue{"debug_tl_car_can_pass", ValueType::Bool, false}, {}, false});
    debug_tl.children.push_back(
        Node{"Stats", ConfigValue{"debug_tl_car_passed", ValueType::Bool, false}, {}, false});
    debug_tl.children.push_back(
